...
public class ProductRestController {
    ...
    @GetMapping("/by-id/{idProduct}")
    public ResponseEntity<Page<ProductView>> getProductByCategory(@PageableDefault(page = 0, size = 3) Pageable pageable, Integer idProduct){
        Page<ProductView> productViews = productService.pageProductByCategory(idProduct, pageable);
